                                              ...
                                              <div>
                                                  <form class="side-search">
                                                      <div class="input-group">
                                                          <input type="text" id="search-item"class="form-control search-wid" placeholder="Search Here" aria-describedby="basic-addon1" onkeyup="search()">
                      ...
                      <div class="collapse navbar-collapse" id="cat-nav-mega">
                          <ul class="nav navbar-nav">
                            ...
                            <li><a href="cosmetics.php">Cosmetic </a></li>
                              ...
                              <li><a href="offers.php">Offers zone </a></li>
                              <li class="cat-img-off"><img src="images/offers.png" alt="off"></li>
                          </ul>
